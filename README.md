...
## Project Overview
This repository contains my Business Data Management (BDM) capstone project completed as part of the IIT Madras BS in Data Science and Applications program.
The project focuses on analysing customer credit behaviour and receivables risk using real-world invoice-level data, with the objective of understanding delayed payments, working capital blockage, and liquidity pressure.
## Problem Statement

The core business problem addressed in this project is inefficient credit management, leading to delayed customer payments and constrained cash flow despite healthy sales performance.
